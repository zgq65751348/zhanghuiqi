package org.security.xpand.client;

import com.alibaba.otter.canal.client.CanalConnector;
import org.security.xpand.annotation.ListenPoint;
import org.security.xpand.client.transfer.TransponderFactory;
...
public class SimpleCanalClient extends AbstractCanalClient {
    ...
    private void initListeners() {
        ...
        Map<String, Object> listenerMap = BeanUtil.getBeansWithAnnotation(org.security.xpand.annotation.CanalEventListener.class);
        if (listenerMap != null) {
